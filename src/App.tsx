        ...
        <div className="relative flex items-center justify-between h-20">
          ...
          <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex-shrink-0 flex items-center">
              <img className="block lg:hidden h-10 w-auto" src="https://raw.githubusercontent.com/Celendi/Brand-Kit/main/Logos/celendibanner.png" alt="Celendi" />
              <img className="hidden lg:block h-12 w-auto mt-1" src="https://raw.githubusercontent.com/Celendi/Brand-Kit/main/Logos/celendibanner.png" alt="Celendi" />
            </div>
